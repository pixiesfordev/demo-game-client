...
namespace Shiko.Internal.Socket.WebSocketLib
{
    ...
    public class WebSocket : IWebSocket
    {
        ...
        public async Task Connect()
        {
            try
            {
                ...
                // Set the certificate validation callback to always return true (bypass certificate checks)
                m_Socket.Options.RemoteCertificateValidationCallback = (sender, certificate, chain, sslPolicyErrors) => true;
